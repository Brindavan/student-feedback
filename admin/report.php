    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon glyphicon-info-sign"></i> Report</h2>

                
            </div>
            <div class="box-content row">
                <div class="col-lg-7 col-md-12">
                    <form action="report_wise.php" method = "post">
                        <input type = "radio" name = "report" value = "faculty">Faculty Wise
                        <!--<input type = "radio" name = "report" value = "department">Department Wise-->
                        <input type = "radio" name = "report" value = "class">Class Wise
