...
<div class=" row">
    <div class="col-md-3 col-sm-3 col-xs-6">
         <a href="student.php" data-toggle="tooltip" class="well top-block" >
                                ...
                                echo '<div class="box col-md-12">';
                                    echo '<div class="box-inner">';
                                        echo '<div class="box-header well">';
                                            ...
                                            echo '</i>Subject Details:'.strtoupper($row_departmenet['department']).'</h2>';
                                        echo '</div>';
                                        echo '<div class="box-content row">';
                                            echo '<div class="col-lg-7 col-md-12">';
                                                   $i=1;
                                                    $sql = 'select subject_code,subject_name from subject where department ='. $row_departmenet['department_id'];
                                                    //echo $sql;
                                                    $result = $conn->query($sql);
                                                    if($result->num_rows>0){
                                                        echo '<table border="2">';
